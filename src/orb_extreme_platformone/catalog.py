...
A leaf module: these catalogs are data, not extract logic. Keeping them here
lets the pure transform layer derive its entity table-key sets from the same
source without importing the I/O layer.
